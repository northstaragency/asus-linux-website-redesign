                ...
                steps: [
                    {
                        ...
                        instruction: 'Launch the app from your applications menu or press Super+R',
                        why: 'The Control Center is your hub for all hardware settings',
                        expected: 'You should see the main dashboard with profile options'
                    },
                    {
                        title: 'Navigate to GPU settings',
                        instruction: 'Click "Graphics" in the sidebar, then select "GPU Mode"',
                        why: 'This is where you choose which GPU powers your system',
